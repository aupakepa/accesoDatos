...
public class EjemplogetExportedKeys {
	...
	public static void main(String[] args) {
		try {
			...
			Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost/departamentos", "usuario", "usuario");
			...
			ResultSet fk = dbmd.getExportedKeys(null, "departamentos", "DEPARTMENTS");
